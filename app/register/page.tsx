    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-on-background">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-heading font-extrabold text-white tracking-tight">Daftar Akun Baru</h1>
          <p className="text-white/70 text-sm mt-2 font-medium">Buat akun untuk mulai memantau data strategis instansi.</p>
        </div>
