...
const chartData = [
  { name: 'Harmonis', value: 342, color: 'var(--color-tertiary)' },
  { name: 'Stable', value: 128, color: 'var(--color-primary)' },
  { name: 'Disharmonis', value: 45, color: 'var(--color-error)' },
]
...
const recentActivities = [
  { 
    ...
    action: "Laporan Semester I dikirim", 
  ...
  { 
    id: 2, 
    kkks: "Medco E&P Malaka", 
    action: "Ketidakhadiran rapat koordinasi", 
  ...
  { 
    id: 3, 
    kkks: "Pertamina EP", 
    action: "Respon korespendensi cepat", 
    time: "Kemarin", 
    status: "success",
    score: "98%"
  },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="rounded-3xl bg-surface-container-lowest p-8 shadow-sm border border-outline-variant/5 relative overflow-hidden group">
            ...
            <StabilityGauge score={94.2} status="HARMONIOUS" />
          </div>
